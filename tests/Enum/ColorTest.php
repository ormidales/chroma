...
class ColorTest extends TestCase
{
	...
	public function testTryFromIdReturnsColorWhenFound(): void
	{
		$this->assertSame(Color::Red500, Color::tryFromId(105));
	}

	public function testTryFromIdReturnsNullWhenNotFound(): void
	{
	...
	public function testTryFromNameReturnsColorWhenFound(): void
	{
		$this->assertSame(Color::Red500, Color::tryFromName('Red500'));
	}

	public function testTryFromNameReturnsNullWhenNotFound(): void
	{
		$this->assertNull(Color::tryFromName('NotAColor'));
	}

	// tryFrom* — code numérique

	public function testTryFromCodeReturnsColorWhenFound(): void
	{
		$this->assertSame(Color::Red500, Color::tryFromCode(500));
	}

	public function testTryFromCodeReturnsNullWhenNotFound(): void
	{
		$this->assertNull(Color::tryFromCode(99999));
	}

	public function testTryFromCodeReturnsNullForInvalidCode(): void
	{
	...
	public function testTryFromTitleReturnsColorWhenFound(): void
	{
		$this->assertSame(Color::Red500, Color::tryFromTitle('Rouge passion'));
	}

	public function testTryFromTitleReturnsNullWhenNotFound(): void
	{
		$this->assertNull(Color::tryFromTitle('Couleur inconnue'));
	}

	// tryFrom* — hexadécimal

	public function testTryFromHexReturnsColorWhenFound(): void
	{
		$this->assertSame(Color::Red500, Color::tryFromHex('#ef4444'));
	}

	public function testTryFromHexReturnsNullWhenNotFound(): void
	{
		$this->assertNull(Color::tryFromHex('#000001'));
	}

	public function testTryFromHexThrowsOnInvalidFormat(): void
	{
		$this->expectException(\InvalidArgumentException::class);
		Color::tryFromHex('not-a-hex');
	}

	// tryFrom* — RGB

	public function testTryFromRgbReturnsColorWhenFound(): void
	{
		$this->assertSame(Color::Red500, Color::tryFromRgb('rgb(239, 68, 68)'));
	}

	public function testTryFromRgbReturnsNullWhenNotFound(): void
	{
	...
	public function testTryFromRgbaReturnsColorWhenFound(): void
	{
		$this->assertSame(Color::Red500, Color::tryFromRgba('rgba(239, 68, 68, 0.5)'));
	}

	public function testTryFromRgbaReturnsNullWhenNotFound(): void
	{
	...
	{
		$this->expectException(\InvalidArgumentException::class);
		Color::tryFromRgba('not-rgba');
	}

	// tryFrom* — HSL

	public function testTryFromHslReturnsColorWhenFound(): void
	{
		$this->assertSame(Color::Red500, Color::tryFromHsl('hsl(0, 84%, 60%)'));
	}

	public function testTryFromHslReturnsNullWhenNotFound(): void
	{
		$this->assertNull(Color::tryFromHsl('hsl(0, 1%, 1%)'));
	}

	public function testTryFromHslThrowsOnInvalidFormat(): void
	{
		$this->expectException(\InvalidArgumentException::class);
		Color::tryFromHsl('not-hsl');
	}

	// tryFrom* — OKLCH

	public function testTryFromOklchReturnsColorWhenFound(): void
	{
		$this->assertSame(Color::Red500, Color::tryFromOklch('oklch(0.6369 0.2078 25.32)'));
	}

	public function testTryFromOklchReturnsNullWhenNotFound(): void
	{
		$this->assertNull(Color::tryFromOklch('oklch(0 0 0.01)'));
	}

	public function testTryFromOklchThrowsOnInvalidFormat(): void
	{
		$this->expectException(\InvalidArgumentException::class);
		Color::tryFromOklch('not-oklch');
	}
}
