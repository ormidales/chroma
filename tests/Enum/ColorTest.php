...
class ColorTest extends TestCase
{
	...
	public function testGetParsedRgbBlack(): void
	{
		$this->assertSame([0, 0, 0], Color::Black->getParsedRgb());
	}

	public function testGetParsedRgbWhite(): void
	{
		$this->assertSame([255, 255, 255], Color::White->getParsedRgb());
	}

	public function testGetParsedRgbRed500(): void
	{
		$this->assertSame([239, 68, 68], Color::Red500->getParsedRgb());
	}

	public function testGetParsedRgbaBlack(): void
	{
		$this->assertSame([0, 0, 0, 1.0], Color::Black->getParsedRgba());
	}

	public function testGetParsedRgbaWhite(): void
	{
		$this->assertSame([255, 255, 255, 1.0], Color::White->getParsedRgba());
	}

	public function testGetParsedRgbaRed500(): void
	{
		$this->assertSame([239, 68, 68, 1.0], Color::Red500->getParsedRgba());
	}

	public function testToStringBlack(): void
	{
		$this->assertSame('Noir (#000000)', Color::Black->toString());
	}

	public function testToStringWhite(): void
	{
		$this->assertSame('Blanc (#ffffff)', Color::White->toString());
	}

	public function testToStringRed500(): void
	{
		$this->assertSame('Rouge passion (#ef4444)', Color::Red500->toString());
	}
	...
	public function testToJsonBlack(): void
	{
		...
		$this->assertSame($expected, Color::Black->toJson());
	}
	...
	public function testToJsonWhite(): void
	{
		...
		$this->assertSame($expected, Color::White->toJson());
	}
	...
	public function testToJsonRed500(): void
	{
		...
		$this->assertSame($expected, Color::Red500->toJson());
	}
}